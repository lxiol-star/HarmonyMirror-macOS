    ...
    var body: some View {
        HStack(spacing: 12) {
            ...
            HStack(spacing: 4) {
                ...
                controlButton("适配窗口", systemImage: "arrow.up.left.and.arrow.down.right", action: onFit)
                controlButton("占满屏幕", systemImage: "arrow.down.right.and.arrow.up.left", action: onFill)
            }
        }
        .font(.caption2)
